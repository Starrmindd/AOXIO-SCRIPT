...
<ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
    ...
    <?php if ($user->enable_offline_payment == 1): ?>
        <li class="nav-item ml-1 mt-1 mr-2 d-none">
                    ...
                    <div class="box col-md-12 m-auto text-center">
                        <div class="box-body text-center">
                            <div class="mt-2">
                                ...
                                <form enctype="multipart/form-data" action="<?php echo base_url('admin/payment/offline_payment_customer/'.$event_id) ?>" method="post" class="form-horizontal mt-3">
